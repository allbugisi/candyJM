...
<style type='text/css' media='print'>
	...
	if ($pengawas['level'] == 'admin') {
		...
		if ($setting['jenjang'] == 'SMK') {
			echo "<li><a href='?pg=pk'><i class='fa  fa-circle-o text-teal'></i> <span> Data Jurusan</span></a></li>";
		}
		echo "
			...
			echo "
								...
								<div class=' row'>
									...
									<div class='  col-md-8'>
										...
										<a href='?pg=nilai'><div class='info-box bg-yellow'>
										...
										<div class='animated swing col-md-4'>
										<a href='?pg=kelas'><div class='info-box bg-navy'>
										...
										<div class='animated swing col-md-4'>
										<a href='?pg=matapelajaran'><div class='info-box bg-purple'>
	...
	elseif ($pg == 'token') {
		...
		if ($pengawas['level'] == 'admin') {
			...
			echo "
						...
						, di $setting[sekolah] telah diselenggarakan " . ucwords(strtolower($kodeujian['nama'])) . " untuk Mata Pelajaran <b>$ujian[nama_mapel]</b> dari pukul <b>$ujian[mulai]</b> sampai dengan pukul <b>$ujian[selesai]</b></td>
						</tr>
						</table>
						<table border='0' width='95%' align='center'>
						<tr height='30'>
	...
	elseif ($pg == 'jadwal') {
		...
		echo "
																<button  class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahjadwal'><i class='glyphicon glyphicon-plus'></i> Tambah Jadwal</button>
															</div>
														</div><!-- /.box-header -->
										<div class='box-body'>
		...
		while ($mapel = mysql_fetch_array($mapelQ)) {
			...
			echo "<b><small class='label bg-red'>$mapel[kode_ujian]</small> <small class='label bg-purple'>$mapel[nama]</small></b> 
																</td>
			...
			echo "</td>
																<td><small class='label label-warning'>$mapel[tampil_pg] Soal / $mapel[lama_ujian] m / $mapel[opsi] opsi</small></td>
			...
			echo "
																...
																<td align='center'>
																	<div class='btn-grou'>
																			...
																			<a class='btn btn-warning btn-flat btn-xs' data-toggle='modal' data-target='#edit$mapel[id_ujian]'><i class='fa fa-pencil-square-o'></i></a>
		...
		while ($berita = mysql_fetch_array($beritaQ)) {
			...
			echo "</td>
																...
																<td align='center'>
																	<div class='btn-group'>
																		<a class='btn btn-flat btn-success btn-flat btn-xs' data-toggle='modal' data-target='#print$berita[id_berita]'><i class='glyphicon glyphicon-print'></i></a>		
																	</div>
																</td>
															</tr>";
									...
									<div class='col-md-12'>
                                            ...
                                            <div class='box box-solid'>
                                                <div class='box-header with-border '>
                                                    <h3 class='box-title'>Import Data Master</h3>
                                                    <div class='box-tools pull-right btn-group'>
                                                        <a href='importdatamaster.xls' class='btn btn-sm btn-flat btn-success'><i class='fa fa-file-excel-o'></i> Download Format</a>
														<a href='?pg=siswa' class='btn btn-sm btn-flat btn-success' title='Batal'><i class='fa fa-times'></i></a>
                                                    </div>
                                                </div><!-- /.box-header -->
                                                <div class='box-body'>
												...
												<div class='box-body'>
                                                    <div class='form-group'>
														...
														<div class='col-md-4'>
														<label>&nbsp;</label><br>
															<button type='submit' name='tambah' class='btn btn-flat btn-success'><i class='fa fa-check'></i> Import Data</button>
														</div>
														</form>
														</div>
                                                    </div>
										...
										<div class='box box-solid'>
											...
											$info
												<table id='tablejenis' class='table table-bordered table-striped'>
													...
													<tbody>";
		$adminQ = mysql_query("SELECT * FROM jenis ORDER BY id_jenis ASC");
		while ($adm = mysql_fetch_array($adminQ)) {
			$no++;
			echo "
															<tr>
